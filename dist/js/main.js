...
function getMoveDirection(e, t, n, a) {
    if (isPhone) {
        ...
        return -135 <= d && d <= -45 ? DIRECTIONS.UP :
            45 < d && d < 135 ? DIRECTIONS.DOWN :
                135 <= d && d <= 180 || -180 <= d && d < -135 ? DIRECTIONS.LEFT :
                    -45 <= d && d < 45 ? DIRECTIONS.RIGHT :
...
function setLightColor() {
    $("#page").style.backgroundColor = "rgba(85,85,85,".concat(getDayLight(), ")"),
        (new Date).getHours() < 17 && (signatureEl.style.color = "#666")
}

function typeSignature() {
    typeSignature.count = typeSignature.count || 0,
        typeSignature.count <= signature.length ? (signatureEl.innerHTML = "".concat(signature.slice(0, typeSignature.count++), "|"),
...
function messenger(i) {
    ...
    o.init = function () {
        ...
        o.animateIn = function () {
            if (o.currentLength < o.messages[o.message].length) o.currentLength = o.currentLength + 2,
                o.currentLength > o.messages[o.message].length && (o.currentLength = o.messages[o.message].length),
